const PUZZLE_META = {
  ...
  p11: {message: '照合一致。Nの本名は新堂奈緒。17:02に制服で出たのは彼女でした。', note: '佐伯からの追送：奈緒の手記には「妹の代わりに出た」とある。妹の記録を探すべきだ。', link: '撮影対象台帳を開く →'},
  p12: {message: '照合一致。写真に写った実在の少女は M-17 でした。', note: '冬真メモ：七海を探すな。M-17の外部保管台帳を探せ。', link: '原記録 M-17 を開く →'},
  p13: {message: '照合一致。M-17の本名は新堂澪。最後の記録が開きます。', note: '佐伯メモ：これで終わりではない。冬真自身の記録も、まだB1-04に残っている。', link: '最後の記録を開く →'}
};
